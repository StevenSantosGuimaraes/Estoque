package br.com.udf.estoque.ui.recyclerview.adapter;
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void configuraMenuDeContexto(@NonNull View itemView) {
            itemView.setOnCreateContextMenuListener((menu, v, menuInfo) -> {
                ...
                menu.findItem(R.id.menu_lista_produtos_remove).setOnMenuItemClickListener(
                    item -> {
                        int posicaoProduto = getAdapterPosition();
                        onItemClickRemoveContextMenuListener.onItemClick(posicaoProduto, produto);
                        return true;
                    });
            });
        }
